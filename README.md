...
4. **Payment Processing**: Payment Service handles transactions asynchronously
5. **Confirmation**: Booking status updates and notifications are sent
6. **Completion**: User receives booking confirmation
